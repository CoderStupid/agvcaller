...
class ZoneD extends StatefulWidget{
  const ZoneD({Key? key}) : super(key: key);
              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        for(int i = 0; i < FFAppState().zoneDWorkingPoint.length; i++)
                          Expanded(child:
                          Padding(
                            padding: const EdgeInsets.all(20),
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                    ...
                                    showDialog(
                                        ...
                                        builder: (BuildContext context){
                                          return AlertDialog(
                                            ...
                                            // content: Text('Transfer Trolley From ${pickUpZone == 'zonea'?'Zone A':'Zone B'} - $pickUpPoint To Zone D - ${FFAppState().zoneDWorkingPoint[i]}',
                                            content: Text(AppLocalizations.of(context)!.confirmTransfer(FFAppState().zoneDWorkingPoint[i], pickUpPoint.toString(), AppLocalizations.of(context)!.zoned, (pickUpZone == 'zonea')?AppLocalizations.of(context)!.zonea:AppLocalizations.of(context)!.zoneb),
                                            ...
                                            actions: <Widget>[
                                              ...
                                              TextButton(
                                                onPressed: () async {
                                                  Navigator.of(context).pop();
                                                  await _postMission(FFAppState().mapName, pickUpPoint, pickUpZone, FFAppState().zoneDWorkingPoint[i], 'zoned');
                                                },
                                ...
                                child: Text('${FFAppState().zoneDWorkingPoint[i]}', style: const TextStyle(fontSize: 20), ),
                              ),
                            ),
                          )
                          )
